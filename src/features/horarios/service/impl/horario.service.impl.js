...
export class HorarioServiceImpl {
    ...
    async configurarDia(datos) {
        ...
        return await this.horarioRepository.guardarHorarioBase(datos.dia_semana, inicio, fin, datos.es_laboral);
    }
    async generarBloquesDelMes(datos) {
        ...
        return {
            ...
            debug: {
                ...
                diasLaborales: reglas.filter((r) => r.es_laboral).map((r) => r.dia_semana),
                rango: `${datos.fecha_inicio} a ${datos.fecha_fin}`
            }
        };
    }
}
//# sourceMappingURL=horario.service.impl.js.map