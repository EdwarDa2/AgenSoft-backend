 ...
 */
export class UsuarioServiceImpl {
    ...
    async login(dto) {
        ...
        // Generar Token JWT
        const token = jwt.sign({ id: usuario.id, email: usuario.email, rol: usuario.rol.nombre }, process.env.JWT_SECRET || 'secret_fallback', { expiresIn: '24h' });
...
//# sourceMappingURL=usuario.service.impl.js.map