...
export class PacienteServiceImpl {
    ...
    async actualizar(id, dto) {
        ...
        if (dto.nombre_completo !== undefined)
            datosActualizacion.nombre_completo = dto.nombre_completo;
        if (dto.telefono !== undefined)
            datosActualizacion.telefono = dto.telefono;
        if (dto.informacion_medica !== undefined)
            datosActualizacion.informacion_medica = dto.informacion_medica;
...
//# sourceMappingURL=paciente.service.impl.js.map