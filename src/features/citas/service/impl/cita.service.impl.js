...
export class CitaServiceImpl {
    ...
    async responderSolicitud(id_cita, aceptar) {
    ...
    async obtenerMisCitas(usuario_id) {
        if (!usuario_id) {
    ...
    async cancelarCita(id_cita, usuario_id) {
    ...
    async reprogramarCita(id_cita, nuevo_bloque_id) {
...
//# sourceMappingURL=cita.service.impl.js.map